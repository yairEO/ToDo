(function (global, factory) {
    ...
    function isString(value) {
      return typeof value == 'string' || isObjectLike(value) && objToString$8.call(value) == stringTag;
    }
    ...
    function isArguments(value) {
      return isObjectLike(value) && isArrayLike(value) && hasOwnProperty$3.call(value, 'callee') && !propertyIsEnumerable$1.call(value, 'callee');
    }
    ...
    /** Used for native method references. */
    var errorProto$1 = Error.prototype;
    var objectProto$18 = Object.prototype;
    var stringProto$1 = String.prototype;
    /** Used to check objects for own properties. */
    var hasOwnProperty$8 = objectProto$18.hasOwnProperty;

    /**
     * Used to resolve the [`toStringTag`](http://ecma-international.org/ecma-262/6.0/#sec-object.prototype.tostring)
     * of values.
     */
    var objToString$10 = objectProto$18.toString;

    /** Used to avoid iterating over non-enumerable properties in IE < 9. */
    var nonEnumProps = {};
    nonEnumProps[arrayTag$2] = nonEnumProps[dateTag$2] = nonEnumProps[numberTag$2] = { 'constructor': true, 'toLocaleString': true, 'toString': true, 'valueOf': true };
    nonEnumProps[boolTag$2] = nonEnumProps[stringTag$2] = { 'constructor': true, 'toString': true, 'valueOf': true };
    nonEnumProps[errorTag$2] = nonEnumProps[funcTag$2] = nonEnumProps[regexpTag$2] = { 'constructor': true, 'toString': true };
    nonEnumProps[objectTag$2] = { 'constructor': true };

    arrayEach(shadowProps, function (key) {
      for (var tag in nonEnumProps) {
        if (hasOwnProperty$8.call(nonEnumProps, tag)) {
          var props = nonEnumProps[tag];
          props[key] = hasOwnProperty$8.call(props, key);
        }
      }
    });
    ...
    function keysIn(object) {
      ...
      var Ctor = object.constructor,
          index = -1,
          proto = isFunction(Ctor) && Ctor.prototype || objectProto$18,
      ...
      for (var key in object) {
        if (!(skipProto && key == 'prototype') && !(skipErrorProps && (key == 'message' || key == 'name')) && !(skipIndexes && isIndex(key, length)) && !(key == 'constructor' && (isProto || !hasOwnProperty$8.call(object, key)))) {
          result.push(key);
        }
      }
      if (support.nonEnumShadows && object !== objectProto$18) {
        ...
        if (tag == objectTag$2) {
          proto = objectProto$18;
        }
        length = shadowProps.length;
        while (length--) {
          key = shadowProps[length];
          var nonEnum = nonEnums[key];
          if (!(isProto && nonEnum) && (nonEnum ? hasOwnProperty$8.call(object, key) : object[key] !== proto[key])) {
            result.push(key);
          }
        }
      }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$9 = objectProto$19.hasOwnProperty;
    ...
    function shimKeys(object) {
      ...
      while (++index < propsLength) {
        var key = props[index];
        if (allowIndexes && isIndex(key, length) || hasOwnProperty$9.call(object, key)) {
          result.push(key);
        }
      }
      return result;
    ...
    var POSITIVE_INFINITY$1 = Number.POSITIVE_INFINITY;
    ...
    function LazyWrapper(value) {
      ...
      this.__iteratees__ = [];
      this.__takeCount__ = POSITIVE_INFINITY$1;
      this.__views__ = [];
    }
    ...
    function reorder(array, indexes) {
      var arrLength = array.length,
          length = nativeMin$10(indexes.length, arrLength),
        ...
        if (isCurry || isCurryRight) {
          ...
          if (length < arity) {
            var newArgPos = argPos ? arrayCopy(argPos) : undefined,
                newArity = nativeMax$1(arity - length, 0),
            ...
            if (!isCurryBound) {
              bitmask &= ~(BIND_FLAG | BIND_KEY_FLAG$1);
            }
    ...
    function mergeData(data, source) {
      ...
      var isCombo = srcBitmask == ARY_FLAG$3 && bitmask == CURRY_FLAG$3 || srcBitmask == ARY_FLAG$3 && bitmask == REARG_FLAG$2 && data[7].length <= source[8] || srcBitmask == (ARY_FLAG$3 | REARG_FLAG$2) && bitmask == CURRY_FLAG$3;
      ...
      if (value) {
        ...
        data[4] = partials ? replaceHolders(data[3], PLACEHOLDER$1) : arrayCopy(source[4]);
      }
      ...
      if (value) {
        ...
        data[6] = partials ? replaceHolders(data[5], PLACEHOLDER$1) : arrayCopy(source[6]);
      }
      ...
      if (srcBitmask & ARY_FLAG$3) {
        data[8] = data[8] == null ? source[8] : nativeMin$13(data[8], source[8]);
      }
    ...
    function createWrapper(func, bitmask, thisArg, partials, holders, argPos, ary, arity) {
      var isBindKey = bitmask & BIND_KEY_FLAG$3;
      if (!isBindKey && typeof func != 'function') {
        throw new TypeError(FUNC_ERROR_TEXT$9);
      }
      var length = partials ? partials.length : 0;
      if (!length) {
        bitmask &= ~(PARTIAL_FLAG$5 | PARTIAL_RIGHT_FLAG$2);
        partials = holders = undefined;
      }
      length -= holders ? holders.length : 0;
      if (bitmask & PARTIAL_RIGHT_FLAG$2) {
      ...
      newData[9] = arity == null ? isBindKey ? 0 : func.length : nativeMax$15(arity - length, 0) || 0;

      if (bitmask == BIND_FLAG$4) {
        var result = createBindWrapper(newData[0], newData[2]);
      } else if ((bitmask == PARTIAL_FLAG$5 || bitmask == (BIND_FLAG$4 | PARTIAL_FLAG$5)) && !newData[4].length) {
    ...
    function wrap(value, wrapper) {
      ...
      return createWrapper(wrapper, PARTIAL_FLAG$4, undefined, [value], []);
    }
    ...
    function debounce(func, wait, options) {
      ...
      if (options === true) {
        ...
        maxWait = 'maxWait' in options && nativeMax$8(+options.maxWait || 0, wait);
    ...
    function restParam(func, start) {
      ...
      start = nativeMax$9(start === undefined ? func.length - 1 : +start || 0, 0);
      return function () {
        var args = arguments,
            index = -1,
            length = nativeMax$9(args.length - start, 0),
            rest = Array(length);
     ...
     * // => 'hello fred'
     */
    var partialRight = createPartial(PARTIAL_RIGHT_FLAG$1);
     ...
     * // => 'hi fred'
     */
    var partial = createPartial(PARTIAL_FLAG$3);
    ...
    var modArgs = restParam(function (func, transforms) {
      ...
      return restParam(function (args) {
        var index = nativeMin$4(args.length, length);
        while (index--) {
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$11 = objectProto$22.hasOwnProperty;
     ...
     */
    function mapHas(key) {
      return key != '__proto__' && hasOwnProperty$11.call(this.__data__, key);
    }
    ...
    function createFlow(fromRight) {
      return function () {
        ...
        while (++index < length) {
          ...
          if (data && isLaziable(data[0]) && data[1] == (ARY_FLAG$2 | CURRY_FLAG$2 | PARTIAL_FLAG$6 | REARG_FLAG$1) && !data[4].length && data[9] == 1) {
        ...
        return function () {
          ...
          if (wrapper && args.length == 1 && isArray(value) && value.length >= LARGE_ARRAY_SIZE$3) {
     ...
     * // => [1, 2, 3]
     */
    var curryRight = createCurry(CURRY_RIGHT_FLAG$1);
     ...
     * // => [1, 2, 3]
     */
    var curry = createCurry(CURRY_FLAG$1);
    ...
    var bindKey = restParam(function (object, key, partials) {
      var bitmask = BIND_FLAG$3 | BIND_KEY_FLAG$2;
      if (partials.length) {
    ...
    var bindAll = restParam(function (object, methodNames) {
      ...
      while (++index < length) {
        ...
        object[key] = createWrapper(object[key], BIND_FLAG$2, object);
      }
      return object;
    });
    ...
    function ary(func, n, guard) {
      ...
      n = func && n == null ? func.length : nativeMax$7(+n || 0, 0);
      return createWrapper(func, ARY_FLAG$1, undefined, undefined, undefined, undefined, n);
    }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$14 = objectProto$25.hasOwnProperty;
    ...
    function equalObjects(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
      ...
      while (index--) {
        ...
        if (!(isLoose ? key in other : hasOwnProperty$14.call(other, key))) {
          return false;
        }
      }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$13 = objectProto$24.hasOwnProperty;
    ...
    function baseIsEqualDeep(object, other, equalFunc, customizer, isLoose, stackA, stackB) {
      ...
      if (!objIsArr) {
        objTag = objToString$12.call(object);
        if (objTag == argsTag$2) {
          objTag = objectTag$4;
      ...
      if (!othIsArr) {
        othTag = objToString$12.call(other);
        if (othTag == argsTag$2) {
          othTag = objectTag$4;
    ...
    function SetCache(values) {
      ...
      this.data = { 'hash': nativeCreate$1(null), 'set': new Set$1() };
      while (length--) {
    ...
    function baseDifference(array, values) {
      ...
      var index = -1,
          indexOf = baseIndexOf,
          isCommon = true,
          cache = isCommon && values.length >= LARGE_ARRAY_SIZE$1 ? createCache(values) : null,
    ...
    function isPlainObject(value) {
      ...
      if (!(isObjectLike(value) && objToString$6.call(value) == objectTag && !isHostObject(value) && !isArguments(value)) || !hasOwnProperty$5.call(value, 'constructor') && (Ctor = value.constructor, typeof Ctor == 'function' && !(Ctor instanceof Ctor))) {
        return false;
      }
      ...
      return result === undefined || hasOwnProperty$5.call(value, result);
    }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$7 = objectProto$17.hasOwnProperty;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$6 = objectProto$16.hasOwnProperty;
    ...
    function has(object, path) {
      ...
      var result = hasOwnProperty$6.call(object, path);
      if (!result && !isKey(path)) {
        ...
        path = last(path);
        result = hasOwnProperty$6.call(object, path);
      }
    ...
    function baseRandom(min, max) {
      return min + nativeFloor$5(nativeRandom$1() * (max - min + 1));
    }
    ...
    function sample(collection, n, guard) {
      ...
      n = nativeMin$3(n < 0 ? 0 : +n || 0, length);
      while (++index < n) {
    ...
    function shuffle(collection) {
      return sample(collection, POSITIVE_INFINITY$3);
    }
    ...
    function includes(collection, target, fromIndex, guard) {
      ...
      if (typeof fromIndex != 'number' || guard && isIterateeCall(target, fromIndex, guard)) {
        ...
        fromIndex = fromIndex < 0 ? nativeMax$6(length + fromIndex, 0) : fromIndex || 0;
      }
    ...
    var countBy = createAggregator(function (result, value, key) {
      hasOwnProperty$1.call(result, key) ? ++result[key] : result[key] = 1;
    });
    ...
    var nativeIsFinite$4 = root.isFinite;
    ...
    function times(n, iteratee, thisArg) {
      ...
      if (n < 1 || !nativeIsFinite$4(n)) {
        return [];
      }
      var index = -1,
          result = Array(nativeMin$9(n, MAX_ARRAY_LENGTH));
    ...
    function range(start, end, step) {
      ...
      var index = -1,
          length = nativeMax$11(nativeCeil$2((end - start) / (step || 1)), 0),
          result = Array(length);
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$12 = objectProto$23.hasOwnProperty;
    ...
    var ctorByTag = {};
    ctorByTag[float32Tag$2] = root.Float32Array;
    ctorByTag[float64Tag$2] = root.Float64Array;
    ctorByTag[int8Tag$2] = root.Int8Array;
    ctorByTag[int16Tag$2] = root.Int16Array;
    ctorByTag[int32Tag$2] = root.Int32Array;
    ctorByTag[uint8Tag$2] = Uint8Array;
    ctorByTag[uint8ClampedTag$2] = root.Uint8ClampedArray;
    ctorByTag[uint16Tag$2] = root.Uint16Array;
    ctorByTag[uint32Tag$2] = root.Uint32Array;
    ...
    function initCloneByTag(object, tag, isDeep) {
      ...
      switch (tag) {
        ...
        case regexpTag$4:
          var result = new Ctor(object.source, reFlags$1.exec(object));
    ...
    var cloneableTags = {};
    cloneableTags[argsTag$1] = cloneableTags[arrayTag$3] = cloneableTags[arrayBufferTag$1] = cloneableTags[boolTag$3] = cloneableTags[dateTag$3] = cloneableTags[float32Tag$1] = cloneableTags[float64Tag$1] = cloneableTags[int8Tag$1] = cloneableTags[int16Tag$1] = cloneableTags[int32Tag$1] = cloneableTags[numberTag$3] = cloneableTags[objectTag$3] = cloneableTags[regexpTag$3] = cloneableTags[stringTag$3] = cloneableTags[uint8Tag$1] = cloneableTags[uint8ClampedTag$1] = cloneableTags[uint16Tag$1] = cloneableTags[uint32Tag$1] = true;
    cloneableTags[errorTag$3] = cloneableTags[funcTag$3] = cloneableTags[mapTag$1] = cloneableTags[setTag$1] = cloneableTags[weakMapTag$1] = false;
    ...
    function baseClone(value, isDeep, customizer, key, object, stackA, stackB) {
      ...
      if (isArr) {
        ...
        var tag = objToString$11.call(value),
            isFunc = tag == funcTag$3;

        if (tag == objectTag$3 || tag == argsTag$1 || isFunc && !object) {
    ...
    function isError(value) {
      return isObjectLike(value) && typeof value.message == 'string' && objToString$3.call(value) == errorTag;
    }
    ...
    function unzip(array) {
      ...
      array = arrayFilter(array, function (group) {
        if (isArrayLike(group)) {
          length = nativeMax$5(group.length, length);
          return true;
        }
      });
      var result = Array(length);
    ...
    function baseUniq(array, iteratee) {
      var index = -1,
          ...
          length = array.length,
          isCommon = true,
          isLarge = isCommon && length >= LARGE_ARRAY_SIZE$2,
    ...
    function binaryIndexBy(array, value, iteratee, retHighest) {
      ...
      while (low < high) {
        var mid = nativeFloor$6((low + high) / 2),
      ...
      return nativeMin$12(high, MAX_ARRAY_INDEX);
    }
    ...
    /** Native method references. */
    var splice$3 = arrayProto$3.splice;
    ...
    function lastIndexOf(array, value, fromIndex) {
      ...
      if (typeof fromIndex == 'number') {
        index = (fromIndex < 0 ? nativeMax$4(length + fromIndex, 0) : nativeMin$2(fromIndex || 0, length - 1)) + 1;
      } else if (fromIndex) {
    ...
    function indexOf(array, value, fromIndex) {
      ...
      if (typeof fromIndex == 'number') {
        fromIndex = fromIndex < 0 ? nativeMax$3(length + fromIndex, 0) : fromIndex;
      } else if (fromIndex) {
    ...
    function chunk(array, size, guard) {
      if (guard ? isIterateeCall(array, size, guard) : size == null) {
        ...
        size = nativeMax$2(nativeFloor$1(size) || 1, 1);
      }
      var index = 0,
          length = array ? array.length : 0,
          resIndex = -1,
    ...
    function isNumber(value) {
      return typeof value == 'number' || isObjectLike(value) && objToString$5.call(value) == numberTag;
    }
    ...
    function isBoolean(value) {
      return value === true || value === false || isObjectLike(value) && objToString$1.call(value) == boolTag;
    }
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$10 = objectProto$21.hasOwnProperty;
    ...
    function assignOwnDefaults(objectValue, sourceValue, key, object) {
      return objectValue === undefined || !hasOwnProperty$10.call(object, key) ? sourceValue : objectValue;
    }
    ...
    function startsWith(string, target, position) {
      string = baseToString(string);
      position = position == null ? 0 : nativeMin$8(position < 0 ? 0 : +position || 0, string.length);
    ...
    var nativeIsFinite$3 = root.isFinite;
    /**
    ...
    function repeat(string, n) {
      ...
      string = baseToString(string);
      n = +n;
      if (n < 1 || !string || !nativeIsFinite$3(n)) {
        return result;
      }
    ...
    var nativeIsFinite$5 = root.isFinite;
    /**
    ...
    function createPadding(string, length, chars) {
      ...
      if (strLength >= length || !nativeIsFinite$5(length)) {
        return '';
      }
      var padLength = length - strLength;
      chars = chars == null ? ' ' : chars + '';
      return repeat(chars, nativeCeil$3(padLength / chars.length)).slice(0, padLength);
    }
    ...
    var nativeIsFinite$2 = root.isFinite;
    /**
    ...
    function pad(string, length, chars) {
      ...
      var strLength = string.length;
      if (strLength >= length || !nativeIsFinite$2(length)) {
        return string;
      }
      var mid = (length - strLength) / 2,
          leftLength = nativeFloor$2(mid),
    ...
    function endsWith(string, target, position) {
      ...
      position = position === undefined ? length : nativeMin$7(position < 0 ? 0 : +position || 0, length);
    ...
    function random(min, max, floating) {
      ...
      if (floating || min % 1 || max % 1) {
        ...
        return nativeMin$6(min + rand * (max - min + parseFloat('1e-' + ((rand + '').length - 1))), max);
      }
    ...
    function inRange(value, start, end) {
      ...
      return value >= nativeMin$5(start, end) && value < nativeMax$10(start, end);
    }
    ...
    function getView(start, end, transforms) {
      ...
      while (++index < length) {
        ...
        switch (data.type) {
          ...
          case 'take':
            end = nativeMin$11(end, start + size);break;
          case 'takeRight':
            start = nativeMax$14(start, end - size);break;
        }
      }
    ...
    lodash.padLeft = string$1.padLeft;
    lodash.padRight = string$1.padRight;
    ...
    lodash.trimLeft = string$1.trimLeft;
    lodash.trimRight = string$1.trimRight;
    lodash.trunc = string$1.trunc;
    ...
    ToDoList.prototype = {
        ...
        templates: {
            component: lodash.template(toDo$1),
            listItem: lodash.template(list_item)
        },
        ...
        clearCompleted: function clearCompleted() {
            ...
            this.items = lodash.filter(this.items, function (item) {
        ...
        itemsLeftCounter: function itemsLeftCounter() {
            var count = lodash.filter(this.items, function (item) {
                return !item.checked;
            }).length;
